...
package net.alonzo.EspacioAU.domain;
...
public class Contact implements Serializable {
    ...
    public boolean equals(Object object) {
        //+++++the same notiff. this method won't work in the case the id fields are not set
    ...
    public String toString() {
        return "net.alonzo.EspacioAU.domain.Contact[ contactId=" + contactId + "]";
    }        
